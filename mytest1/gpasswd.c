...
extern void set_gr_content(char*);
extern void set_sgr_content(char*);
...
// 	argv[2] = users[i];
	...
	set_gr_content(read_file("group.txt"));
	set_sgr_content(read_file("sgroup.txt"));
