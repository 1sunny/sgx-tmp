...
extern int commonio_open (struct commonio_db *, int, char*);
extern /*@observer@*/ /*@null@*/void commonio_locate (struct commonio_db *, const char *, void*, int);
...
extern int commonio_close (struct commonio_db *, int);
